...
% Right now your paper feels a bit limited; it is very direct and clearly saying: "this dataset exists and here is what it is," but I feel like you can say more. Maybe this is non-standard among dataset papers, but I think some additional motivation wouldn't hurt, which you could do by pointing out how impactful MIMIC has been, but then describing how the eICU dataset fills some of the limitations of MIMIC.
...
%To enhance readability we use camel case where possible.
...
% nursecharting_iabp Caplillary Refill/Left Hand, Distal Pulse, IABP Ratio, Site Check, Left Brachial Pulse, IABP Assisted Diastolic, IABP Assisted Systolic, IABP Assisted Mean, IABP % Augmentation, IABP Diastolic Augmented Pressure, Flush, Dorsiflexion, and Comments***
...
\footnotetext[1]{https://eicu-crd.mit.edu/}
...
%\newblock \emph{\bibinfo{journal}{https://eicu-crd.mit.edu}}
%(\bibinfo{year}{Accessed: April 2018}).

\bibitem{eicu-code}
Pollard T. J., Johnson A. E. W., Badawi O., Naumann T. J., Komorowski M., Rincon T., and Raffa J. D.
\newblock MIT-LCP/eicu-code: eICU-CRD Code Repository v1.0.
\newblock \emph{Zenodo}, https://doi.org/10.5281/zenodo.1249016 (\bibinfo{year}{Accessed: May 2018}).

\bibitem{NHS2005}
{Department of Health}.
\newblock {NHS reference costs 2004-2005} (2006).
\newblock Available from: https://www.gov.uk/government/collections/nhs-reference-costs (\bibinfo{year}{Accessed: 15 May 2018}).

\bibitem{NHS2010}
{Department of Health}.
\newblock {NHS Reference Costs 2009-2010} (2011).
\newblock Available from: https://www.gov.uk/government/collections/nhs-reference-costs (\bibinfo{year}{Accessed: 15 May 2018}).
...
\newblock {\em BMC Medical Informatics and Decision Making}, 11(1):7 (2011).

\bibitem{halpern2010critical}
...
\newblock {\em Critical Care Medicine}, 38(1):65--71 (2010).
...
\newblock Available from: https://www.gpo.gov/fdsys/pkg/PLAW-104publ191/html/PLAW-104publ191.htm (\bibinfo{year}{Accessed: 15 May 2018}).
...
\newblock {\em JAMIA Open}, In Press. DOI: 10.1093/jamiaopen/ooy012
...
\newblock \emph{Zenodo}, https://doi.org/10.5281/zenodo.1248994 (\bibinfo{year}{Accessed: 15 May 2018}).
